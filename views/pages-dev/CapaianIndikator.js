...
import { apiDataNasional, apiPrioritasKabupaten } from '../../services/api.js';

const CapaianIndikator = {
  /**
   * Render the page content.
   */
  render: async () => {

    const widgetCard2 = await WidgetCard.render('tile-2', 'Stunting', 'liwhitee-100', 'lg-7 ms-2 p-0');
    const widgetCard3 = await WidgetCard.render('tile-3', 'Underweight', 'white-100', 'lg mx-2 p-0');
    const widgetCard4 = await WidgetCard.render('tile-4', 'Wasting', 'white-100', 'lg me-2 p-0');
  ...
  after_render: async () => {
    geoData.dataNasional = (typeof geoData.dataNasional === "undefined") ? await apiDataNasional() : geoData.dataNasional;
    geoData.dataPrioritasKabupaten = (typeof geoData.dataPrioritasKabupaten === "undefined") ? await apiPrioritasKabupaten() : geoData.dataPrioritasKabupaten;

    $(function () {
      PetaPropinsi(geoData.dataPrioritasKabupaten);
    ...
    tile2.innerHTML = html2;
    tile3.innerHTML = html3;
    tile4.innerHTML = html4;

    let
      groupByTahunX = arr_groupBy(['tahun']),
      dStuntingTable = groupByTahunX(geoData.dataNasional.stunting),
      dWastingTable = groupByTahunX(geoData.dataNasional.wasting),
      dUnderweightTable = groupByTahunX(geoData.dataNasional.underweight)
      ;

    document.querySelector("#data_stunting_nasional").innerHTML = /*html*/`
    <div class="d-flex justify-content-between bd-highlight m-0 p-0 my-2">
      ...
      <div class="bd-highlight">
        ...
        <table class="table fs-12px">
          ...
          <tbody>
            <tr>
              <td>${dStuntingTable[2007][0].pb_u_stunting}</td>
              <td>${dStuntingTable[2010][0].pb_u_stunting}</td>
              <td>${dStuntingTable[2013][0].pb_u_stunting}</td>
              <td>${dStuntingTable[2018][0].pb_u_stunting}</td>
            </tr>
            <tr>
              <td class="text-center">${(typeof dStuntingTable[2007][1] === 'undefined') ? "-" : dStuntingTable[2007][1].pb_u_stunting}</td>
              <td class="text-center">${(typeof dStuntingTable[2010][1] === 'undefined') ? "-" : dStuntingTable[2010][1].pb_u_stunting}</td>
              <td class="text-center">${(typeof dStuntingTable[2013][1] === 'undefined') ? "-" : dStuntingTable[2013][1].pb_u_stunting}</td>
              <td class="text-center">${(typeof dStuntingTable[2018][1] === 'undefined') ? "-" : dStuntingTable[2018][1].pb_u_stunting}</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div class="bd-highlight ms-n2">
        ...
        <table class="table fs-12px">
          ...
          <tbody>
            <tr>
              <td>${dStuntingTable[2015][0].pb_u_stunting}</td>
              <td>${dStuntingTable[2016][0].pb_u_stunting}</td>
              <td>${dStuntingTable[2017][0].pb_u_stunting}</td>
            </tr>
            <tr>
      ...
      <div class="bd-highlight ms-n2">
        ...
        <table class="table fs-12px">
          ...
          <tbody>
            <tr>
              <td>${dStuntingTable[2019][0].pb_u_stunting}</td>
            </tr>
            <tr>
              <td class="text-center"> - </td>
            </tr>    
      ...
      <div class="bd-highlight ms-n2">
        ...
        <table class="table fs-12px">
          ...
          <tbody>
            <tr>
              <td>${dStuntingTable[2021][0].pb_u_stunting}</td>
            </tr>
            <tr>
              <td class="text-center"> - </td>
            </tr>    
      ...
      <div class="bd-highlight ms-n2">
        ...
        <table class="table fs-12px">
          ...
          <tbody>
            <tr>
              <td>${dStuntingTable[2022][0].pb_u_stunting}</td>
            </tr>
            <tr>
              <td class="text-center"> - </td>
            </tr>
    ...
    document.querySelector("#data_underweight_nasional").innerHTML = /*html*/`
    <div class="d-flex justify-content-between bd-highlight my-2">
      ...
      <table class="table fs-12px">
        ...
        <tbody>
          <tr>
            <td>${dUnderweightTable[2018][0].jml_a1}</td>
          </tr>
          <tr>
            <td>${(typeof dUnderweightTable[2018][1] === 'undefined') ? "-" : dUnderweightTable[2018][1].jml_a1}</td>
          </tr>
        </tbody>
      </table>
    </div>
    <div class="bd-highlight mx-1">
      ...
      <table class="table fs-12px">
        ...
        <tbody>
          <tr>
            <td>${dUnderweightTable[2019][0].jml_a1}</td>
          </tr>   
          <tr>
            <td class="text-center"> - </td>
          </tr>
    ...
    document.querySelector("#data_wasting_nasional").innerHTML = /*html*/`
    <div class="d-flex justify-content-between bd-highlight my-2">
    <div class="bd-highlight mx-1">
        <table class="table fs-12px" style="margin-top: 1.85em;margin-right: -1em;">
          <thead>
      ...
      <div class="bd-highlight mx-1">
        ...
        <table class="table fs-12px">
          ...
          <tbody>
            <tr>
              <td>${dWastingTable[2018][0].jml_a1}</td>
            </tr>
            <tr>
              <td>${(typeof dWastingTable[2018][1] === 'undefined') ? "-" : dWastingTable[2018][1].jml_a1}</td>
            </tr>
          </tbody>
        </table>
      </div>
      <div class="bd-highlight mx-1">
        ...
        <table class="table fs-12px">
          ...
          <tbody>
            <tr>
              <td>${dWastingTable[2019][0].jml_a1}</td>
            </tr>    
            <tr>
              <td class="text-center"> - </td>
            </tr>
...
export default CapaianIndikator;
