...
const KinerjaAnggaran = {
  ...
  after_render: async () => {
    ...
    async function tableData(result, opsiTabel = { expand: false }) {
      ...
      /* document.getElementById("download-pdf-kp1").addEventListener("click", function () {
        table.download("pdf", "Indikasi Konvergensi Implementasi.pdf", {
          orientation: "landscape", //set page orientation to portrait
          title: "Indikasi Konvergensi Implementasi", //add title to report
          unit: 'in',
          format: 'tabloid',
