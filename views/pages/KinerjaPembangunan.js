import WidgetCard from"../components/WidgetCard.js";import{apiKementerian,apiTahunSemester,apiIntervensi}from"../../services/api.js";const KinerjaAnggaran={render:async()=>{mData.dataKementerian=void 0===mData.dataKementerian?await apiKementerian():mData.dataKementerian,mData.dataIntervensi=void 0===mData.dataIntervensi?await apiIntervensi():mData.dataIntervensi;return`
                ...
                <div class="card-body">
                  ...
                  <div class="tab-pane fade active show" id="default-tab-1">
                    <div class="d-flex justify-content-between bd-highlight">              
                      ...
                      ${user.export?`<div class="d-flex flex-row bd-highlight flex-row-reverse fw-600 text-gray-700 my-2 mt-n1 fs-11px" >
    ...
    `},after_render:async()=>{$(function(){$("select").selectpicker()});let a=document.getElementById("sel_ta"),l=document.getElementById("sel_kl"),h=document.getElementById("sel_int"),e=[],i=[],n=()=>{var a=`
        <div class="d-flex justify-content-center ">
            ...
            </div>`);let a=m.lokusIntervensi,e=0,i=0,t=0,s=0,l=0,n=0,d=0,r=0,o=0,c=0,p=0,h=0;a.forEach(a=>{e+=a.lokasi_kota,l+=a.lokasi_provinsi,o+=a.lokasi_pusat,"A"==a.intervensi_kode?(i+=a.lokasi_kota,n+=a.lokasi_provinsi,c+=a.lokasi_pusat):"B"==a.intervensi_kode?(t+=a.lokasi_kota,d+=a.lokasi_provinsi,p+=a.lokasi_pusat):"C"==a.intervensi_kode&&(s+=a.lokasi_kota,r+=a.lokasi_provinsi,h+=a.lokasi_pusat)}),$("#lokus_kabkota_spes").html(i),$("#lokus_propinsi_spe").html(n),$("#lokus_pusat_spe").html(c),$("#lokus_kabkota_sen").html(t),$("#lokus_propinsi_sen").html(d),$("#lokus_pusat_sen").html(p),$("#lokus_kabkota_duk").html(s),$("#lokus_propinsi_duk").html(r),$("#lokus_pusat_duk").html(h),$("#lokus_kabkota").html(e),$("#lokus_propinsi").html(l),$("#lokus_pusat").html(o)})})(),(async()=>{let s,a=document.getElementById("sel_ta").value,e=a.split("-");try{let a=await fetch(config.api_url+"/iki/chart-3",{method:"POST",body:JSON.stringify({tahun:e[0],semester:e[1],kl:d,intervensi:r}),headers:config.fetchHeaders});var i=await a.json();s=i.data}catch(a){return}l.innerHTML=`  
          <div class="row">
          ...
          <div class="container p-0 ps-2">
            ...
            `);let a=m.pelaksanaanKoordinasi1,e=m.pelaksanaanKoordinasi2;a.forEach(a=>{"Ada Koordinasi"==a.category&&$("#ada_kordinasi").html(a.value),"Tidak Ada Koordinasi"==a.category&&$("#tdk_ada_kordinasi").html(a.value),"N/A"==a.category&&$("#n_a").html(a.value)}),e.forEach(a=>{"Pemda"==a.name&&$("#kor_pemda").html(a.value),"K/L Lain"==a.name&&$("#kor_kl").html(a.value),"Non-Pemerintah"==a.name&&$("#kor_pem").html(a.value)})})})()):$("#top-tiles,#top-tiles2,#top-tiles3,#tile-detail").hide()}async function u(a,e){console.log(e);let i=a.split("-"),t;t=e.length<1?{tahun:i[0],semester:i[1]}:{tahun:i[0],semester:i[1],ro:e},console.log(t);try{let a=await fetch(config.api_url_v3+"/ka/lokus-ro",{method:"POST",body:JSON.stringify(t),headers:config.fetchHeaders});var s=await a.json();return console.log(mData.dataRoLokus),console.log(s.data),s.data}catch(a){return!1}}if(Object.values(f.options).forEach(a=>{t.push(a.getAttribute("value"))}),Object.values(v.options).forEach(a=>{s.push(a.getAttribute("value"))}),await d(g,t,s).then(function(a){var e=document.getElementById("kinerjaAnggaranSrc").value;p(a,g,t,s,e),o(a)}),$("#kinerja_pembangunan_form_1").on("click",async function(){n();let e=$("#sel_ta").val(),i=document.getElementById("kinerjaAnggaranSrc").value,t=$("#sel_kl").val(),s=$("#sel_int").val();var l=$(".open_table1").hasClass("opentable")?{expand:!0}:{expand:!1};await d(e,t,s,i).then(function(a){p(a,e,t,s,i),o(a,l)})}),$("#kinerja_pembangunan_form_2").on("click",async function(){n();let e=$("#sel_ta").val(),i=$("#kinerjaAnggaranSrc").val(),t=$("#sel_kl").val(),s=$("#sel_int").val();var l=$(".open_table2").hasClass("opentable")?{expand:!0}:{expand:!1};await r(e,t,s,i).then(function(a){c(a,l),p(a,e,t,s,i)})}),$("#kinerjaAnggaranSrc").keypress(async function(a){let e=a.which,i=$(this).val(),t=$("#sel_ta").val(),s=$("#sel_kl").val(),l=$("#sel_int").val();13==e&&(n(),$("#restoreData").removeClass("hide"),$(this).after(""),$("#kinerja_pembangunan_form_1").data("active")?await d(t,s,l,i).then(function(a){p(a,t,s,l,i),o(a)}):await r(t,s,l,i).then(function(a){p(a,t,s,l,i),c(a)}))}),$("#sel_ta, #sel_kl, #sel_int").on("change",async()=>{n();let e=$("#sel_ta").val(),i=document.getElementById("kinerjaAnggaranSrc").value,t=$("#sel_kl").val(),s=$("#sel_int").val();$("#kinerja_pembangunan_form_1").data("active")?await d(e,t,s,i).then(function(a){p(a,e,t,s,i),o(a)}):await r(e,t,s,i).then(function(a){p(a,e,t,s,i),c(a)})}),$(".open_table1").on("click",async function(){$(this).toggleClass("opentable"),e=$(this).hasClass("opentable")?($(this).find(".material-icons").html("open_in_full"),$(this).find(".material-text").html("Close All"),{expand:!0}):($(this).find(".material-icons").html("close_fullscreen"),$(this).find(".material-text").html("Open All"),{expand:!1});var e,a=$("#sel_ta").val(),i=document.getElementById("kinerjaAnggaranSrc").value;await d(a,$("#sel_kl").val(),$("#sel_int").val(),i).then(function(a){o(a,e)})}),$(".open_table2").on("click",async function(){$(this).toggleClass("opentable"),e=$(this).hasClass("opentable")?($(this).find(".material-icons").html("open_in_full"),$(this).find(".material-text").html("Close All"),{expand:!0}):($(this).find(".material-icons").html("close_fullscreen"),$(this).find(".material-text").html("Open All"),{expand:!1});var e,a=$("#sel_ta").val(),i=document.getElementById("kinerjaAnggaranSrc").value;await r(a,$("#sel_kl").val(),$("#sel_int").val(),i).then(function(a){c(a,e)})}),$("#kinerja_pembangunan_form_1").on("click",function(){$("#default-tab-1").removeClass("hide"),$("#default-tab-2").addClass("hide")}),$("#kinerja_pembangunan_form_2").on("click",function(){$("#default-tab-2").removeClass("hide"),$("#default-tab-1").addClass("hide")}),$("#sel_ta,#sel_ro").on("change",async()=>{$("#peta-ro-lokus").addClass("loading");let a=$("#sel_ta").val(),e=a.split("-"),i=e[0],t=$("#sel_ro").val();"2021"<i?($("#ro-lokus-detail").removeClass("hide"),$(".sel_kl").parent().addClass("hide"),$(".sel_ig").parent().addClass("hide"),$("#kinerjaAnggaranSrc").parent().parent().addClass("hide"),console.log("periode",a),console.log("ro select",t),await u(a,t).then(function(a){console.log("data",a),$("#peta-ro-lokus").removeClass("loading"),viewMapKinerjaPembangunan(a)}),$(".sel_ro").parent().removeClass("hide")):($("#ro-lokus-detail").addClass("hide"),$(".sel_ro").parent().addClass("hide"),$(".sel_kl").parent().removeClass("hide"),$(".sel_ig").parent().removeClass("hide"),$("#kinerjaAnggaranSrc").parent().parent().removeClass("hide"))}),await u("2022-1",[]).then(function(a){mData.dataRoLokus=a.field}),void 0!==mData.dataRoLokus){let e=[];mData.dataRoLokus.forEach(a=>{e.push(`<option value="${a.ro_field}" class="text-warp">
              ${a.ro_code+"-"}
              ${a.ro_name}
          </option>`)}),$("#sel_ro").html(e),$("#sel_ro").selectpicker("destroy"),$("#sel_ro").selectpicker(),$(".sel_ro .dropdown-menu").addClass("w-100")}$(".dropdown-toggle").on("click",function(){$(".sel_ro .dropdown-menu .inner ul li a span.text").addClass("text-wrap")});const b=[].slice.call(document.querySelectorAll('[data-bs-toggle="popover"]'));b.map(function(a){return new bootstrap.Popover(a)})}};export default KinerjaAnggaran;